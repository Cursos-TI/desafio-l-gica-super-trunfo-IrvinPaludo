...
int main()
{
    ...
    // Menu
    printf("Escolha duas categoria:\n");
    printf("1.População\n2.Area\n3.PIB\n4.Pontos turisticos\n5.Densidade populacional\n6.PIB per capto\n7.Super\n");
    scanf("%d", &opmenu1);
    scanf("%d",&opmenu2);

    // vencedor com  if/else
   
    if ((opmenu1 != opmenu2) && (opmenu1 > 0 && opmenu1 < 8) && (opmenu2 > 0 && opmenu2 < 8))
    {
     //primeira comparação
    ...
    case 4:
        ...
        printf("A carta vencedora é:\n");
        somacarta1 = Pon_Turis1;
        somacarta2 = Pon_Turis2 ;
    ...
    case 5:
        ...
        printf("A carta vencedora é:\n");
        somacarta1 = Dencidade1;
        somacarta2 = Dencidade2;
    ...
    case 6:
        ...
        printf("A carta vencedora é:\n");
        somacarta1 = PibperCapt1;
        somacarta2 = PibperCapt2;
    ...
    // verifica o vencedor da soma dos atributos
    
    printf("Somas de valores:\n");
    printf("Carta 1 %s : %0.2f\n",Nome_cidade1,somacarta1);
    printf("Carta 2 %s : %0.2f\n",Nome_cidade2,somacarta2);
    
    if (somacarta1 > somacarta2){
        printf("A cata vencedora é:\n");
        printf("## %s ##\n \n",Nome_cidade1);
